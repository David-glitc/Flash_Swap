...
function Navbar() {
  ...
  return (
    <div>
      <nav className="bg-white my-2 py-4 border-gray-200 dark:bg-gray-900 mx-4 rounded-2xl shadow-xl">
        <div className="max-w-screen-xl  justify-items-start flex gap-3 flex-wrap items-center justify-between mx-auto px-2">
          ...
          <div className="flex md:order-2 space-x-3 px-2 md:space-x-0 rtl:space-x-reverse">
