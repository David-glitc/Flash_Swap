...
import formatNumber from "../Price_formatter";
import { useTonAddress } from "@tonconnect/ui-react";
import useJettons from "../hooks/useJettons";

function SwapForm() {
  const userFriendlyAddress = useTonAddress();
  const userJettons = useJettons(userFriendlyAddress);
  const [InputJetton, SetInputjetton] = useState("USDT");
  const [InputJettonAmount, SetInputjettonAmount] = useState(0);

  console.log();

  return (
    <div>
      <form className="max-w-xl min-w-24 my-10 px-4 mx-auto">
        <div className="space-x-0 space-y-5  sm:space-y-0 sm:space-x-4 rtl:space-x-reverse flex items-center  flex-col rounded-2xl shadow-xl dark:bg-gray-900 p-6 gap-5 mb-4">
          <div className="flex -z-1">
            ...
            <div className="relative w-full">
              <input
                ...
                onChange={(e) => {
                  SetInputjettonAmount(parseInt(e.target.value));
                }}
                className="block text-right placeholder:text-opacity-5 p-3 w-full z-20 text-sm text-gray-900 bg-gray-50 rounded-s-lg border-e-gray-50 border-e-2 border border-gray-300 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-e-gray-700  dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:border-blue-500"
                placeholder="421 "
                required
              />
            </div>
          ...
          <div className="flex">
            ...
            <button
              ...
              type="button"
            >
              <svg className="h-4 w-4 me-2" fill="none" viewBox="0 0 16 15">
                <path
                  fill="#F7931A"
                  ...
                  >
                    <div className="inline-flex items-center">
                      ...
                      >
                        <path
                          fill="#C2A633"
                          d="M16 8.5a8 8 0 11-16 0 8 8 0 0116 0z"
                        />
                        <path
                          fill="#fff"
                          fill-rule="evenodd"
                          d="M5.355 12.685h2.761S12 13.015 12 8.567c0-4.275-3.546-4.26-4.232-4.257H5.355v3.73H4.38v.914h.974v3.73zM6.91 5.858H8c.407 0 2.458.167 2.461 2.74.003 2.542-2.064 2.54-2.396 2.539H6.91V8.954h1.715v-.913H6.91V5.858z"
                          clip-rule="evenodd"
                        />
                      </svg>
                      DOGE
                  ...
                  >
                    <div className="inline-flex items-center">
                      <svg
                        ...
                        viewBox="0 0 16 13"
                      >
                        <g clip-path="url(#clip0_460_40742)">
                          <path
                            fill="url(#paint0_linear_460_40742)"
                            d="M2.599 9.8a.524.524 0 01.37-.152h12.77c.233 0 .35.282.185.447L13.4 12.617a.523.523 0 01-.37.153H.261a.261.261 0 01-.184-.447l2.522-2.522z"
                          />
                          <path
                            fill="url(#paint1_linear_460_40742)"
                            d="M2.599.383a.538.538 0 01.37-.153h12.77c.232 0 .35.282.184.446L13.401 3.2a.523.523 0 01-.37.153H.26a.262.262 0 01-.185-.447L2.599.383z"
                          />
                          <path
                            fill="url(#paint2_linear_460_40742)"
                            d="M13.401 5.062a.523.523 0 00-.37-.153H.261a.262.262 0 00-.184.446l2.522 2.523c.097.096.23.153.37.153h12.77c.233 0 .35-.282.185-.447L13.4 5.062z"
                          />
                        </g>
                        <defs>
                          <linearGradient
